...
export default function ProductManagement({ BACKEND_URL, token, setError, setSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!numId || !data.title || !numRating || !numPrice || (!editingProduct && !image)) {
      ...
      <div className="p-6 border-b bg-gray-50">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input name="color" placeholder="Color" defaultValue={editingProduct?.color} className="border rounded px-3 py-2" />
